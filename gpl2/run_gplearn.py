...
for file in train_files:
    ...
    est_gp = SymbolicRegressor(population_size=1000,
                               ...
                               n_jobs=-1, metric=scaled_rmse_fitness, random_state=1)
    ...
    #a = clf.intercept_
    b = np.sum(((y_train_pred-np.average(y_train_pred))*(y_train-np.average(y_train)))/(y_train_pred-np.average(y_train_pred))**2)
